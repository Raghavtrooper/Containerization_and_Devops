...
![](../screenshots/Lab11i/5.png)  

Check containers:

![](../screenshots/Lab11i/6.png)  
...
![](../screenshots/Lab11i/8.png)  

Verify scaling:  

![](../screenshots/Lab11i/9.png)  
![](../screenshots/Lab11i/10.png)  
![](../screenshots/Lab11i/11.png)  
...
![](../screenshots/Lab11i/14.png)  

Verify removal:

![](../screenshots/Lab11i/15.png)  
...
A multi-container WordPress application was deployed using a Compose file, scaled to multiple replicas, and tested for self-healing capabilities. Swarm provides built-in load balancing, automatic recovery, and cluster management, making it more suitable for production environments than Docker Compose.
